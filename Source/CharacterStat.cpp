...
void CharacterStat::AddModifier(StatModifier mod)
{
	...
	std::sort(statModifiers.begin(), statModifiers.end(), CompareModifierOrder); // TODO: Create Test Case
}

bool CharacterStat::CompareModifierOrder(const StatModifier& a, const StatModifier& b)
{
